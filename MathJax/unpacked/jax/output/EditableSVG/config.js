 ...
 *
 *  Initializes the EditableSVG OutputJax (the main definition is in
 *  MathJax/jax/input/EditableSVG/jax.js, which is loaded when needed).
 *
 *  ---------------------------------------------------------------------
 *
...
MathJax.OutputJax.EditableSVG = MathJax.OutputJax({
  id: "EditableSVG",
  version: "2.5.0",
  ...
  config: {
    ...
    styles: {
      ...
      //
      ".MathJax_EditableSVG .MJX-monospace": {
      ...
      //
      ".MathJax_EditableSVG .MJX-sans-serif": {
...
if (!MathJax.Hub.config.delayJaxRegistration) {MathJax.OutputJax.EditableSVG.Register("jax/mml")}

MathJax.OutputJax.EditableSVG.loadComplete("config.js");
